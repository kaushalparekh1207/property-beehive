...
class RentPropertyController extends Controller
{
    ...
    public function searchRentProperty(Request $request)
    {
        ...
        return view('front.rent-property-result', compact('type_id', 'city_id', 'taluka_id', 'category_id', 'custom_filter', 'budget', 'amenities'));
    }

    public function rentPropertyResultSearchList(Request $request)
    {
        ...
        if ($type_id == 1 || $searchByType == 1) {
            ...
            if ($custom_filter == 'yes') {
                ...
                $totalCount = PropertyMaster::select('count(*) as allcount')
                    ...
                    if ($bathRoomFilter) {
                        $totalCount->where('commercial_properties.total_bathrooms', $bathRoomFilter);
                    }
                    if ($bhkFilter) {
                        $totalCount->whereRaw("commercial_properties.total_bedrooms IN($selectedBhkFilter)");
                    }
                    if ($furnishedStatusFilter) {
                        $totalCount->whereRaw("commercial_properties.furnished_status IN($selectedFurnishedStatus)");
                    }
                    if ($possessionStatusFilter) {
                        $totalCount->where('commercial_properties.possession_status', $possessionStatusFilter);
                    }
                    if ($sortByFilter && $sortByFilter == 1) {
                        $totalCount->where('property_masters.expected_price', '<', '5000000');
                    }
                ...
                $totalFilterCount = PropertyMaster::select('count(*) as allcount')
                    ...
                    if ($bathRoomFilter) {
                        $totalFilterCount->where('commercial_properties.total_bathrooms', $bathRoomFilter);
                    }
                    if ($bhkFilter) {
                        $totalFilterCount->whereRaw("commercial_properties.total_bedrooms IN($selectedBhkFilter)");
                    }
                    if ($furnishedStatusFilter) {
                        $totalFilterCount->whereRaw("commercial_properties.furnished_status IN($selectedFurnishedStatus)");
                    }
                    if ($possessionStatusFilter) {
                        $totalFilterCount->where('commercial_properties.possession_status', $possessionStatusFilter);
                    }
                    if ($sortByFilter && $sortByFilter == 1) {
                        $totalFilterCount->where('property_masters.expected_price', '<', '5000000');
                    }
                ...
                $data = PropertyMaster::join('commercial_properties', 'commercial_properties.property_master_id', '=', 'property_masters.id')
                    ...
                    if ($bathRoomFilter) {
                        $data->where('commercial_properties.total_bathrooms', $bathRoomFilter);
                    }
                    if ($bhkFilter) {
                        $data->whereRaw("commercial_properties.total_bedrooms IN($selectedBhkFilter)");
                    }
                    if ($furnishedStatusFilter) {
                        $data->whereRaw("commercial_properties.furnished_status IN($selectedFurnishedStatus)");
                    }
                    if ($possessionStatusFilter) {
                        $data->where('commercial_properties.possession_status', $possessionStatusFilter);
                    }
                    if ($sortByFilter && $sortByFilter == 1) {
                        $data->where('property_masters.expected_price', '<', '5000000');
                    }
            ...
            if ($custom_filter == 'yes') {
                ...
                $totalCount = PropertyMaster::select('count(*) as allcount')
                    ...
                    if ($bathRoomFilter) {
                        $totalCount->where('industrial_properties.total_bathrooms', $bathRoomFilter);
                    }
                    if ($bhkFilter) {
                        $totalCount->whereRaw("industrial_properties.total_bedrooms IN($selectedBhkFilter)");
                    }
                    if ($furnishedStatusFilter) {
                        $totalCount->whereRaw("industrial_properties.furnished_status IN($selectedFurnishedStatus)");
                    }
                    if ($possessionStatusFilter) {
                        $totalCount->where('industrial_properties.possession_status', $possessionStatusFilter);
                    }
                    if ($sortByFilter && $sortByFilter == 1) {
                        $totalCount->where('property_masters.expected_price', '<', '5000000');
                    }
                ...
                $totalFilterCount = PropertyMaster::select('count(*) as allcount')
                    ...
                    if ($bathRoomFilter) {
                        $totalFilterCount->where('industrial_properties.total_bathrooms', $bathRoomFilter);
                    }
                    if ($bhkFilter) {
                        $totalFilterCount->whereRaw("industrial_properties.total_bedrooms IN($selectedBhkFilter)");
                    }
                    if ($furnishedStatusFilter) {
                        $totalFilterCount->whereRaw("industrial_properties.furnished_status IN($selectedFurnishedStatus)");
                    }
                    if ($possessionStatusFilter) {
                        $totalFilterCount->where('industrial_properties.possession_status', $possessionStatusFilter);
                    }
                    if ($sortByFilter && $sortByFilter == 1) {
                        $totalFilterCount->where('property_masters.expected_price', '<', '5000000');
                    }
                ...
                $data = PropertyMaster::join('industrial_properties', 'industrial_properties.property_master_id', '=', 'property_masters.id')
                    ...
                    if ($bathRoomFilter) {
                        $data->where('industrial_properties.total_bathrooms', $bathRoomFilter);
                    }
                    if ($bhkFilter) {
                        $data->whereRaw("industrial_properties.total_bedrooms IN($selectedBhkFilter)");
                    }
                    if ($furnishedStatusFilter) {
                        $data->whereRaw("industrial_properties.furnished_status IN($selectedFurnishedStatus)");
                    }
                    if ($possessionStatusFilter) {
                        $data->where('industrial_properties.possession_status', $possessionStatusFilter);
                    }
                    if ($sortByFilter && $sortByFilter == 1) {
                        $data->where('property_masters.expected_price', '<', '5000000');
                    }
