...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 31, 2023 at 10:49 AM
...
CREATE TABLE IF NOT EXISTS `agricultural_properties` (
  ...
  `security_amount` int DEFAULT NULL,
  `maintenance_charges` int DEFAULT NULL,
  `charges_per` int DEFAULT NULL,
  `flag` int NOT NULL DEFAULT '1' COMMENT '1=Active, 2=>Inactive',
  `created_by` int DEFAULT NULL,
  `updated_by` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `commercial_properties` (
  ...
  `security_amount` int DEFAULT NULL,
  `maintenance_charges` int DEFAULT NULL,
  `charges_per` varchar(99) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `flag` int NOT NULL DEFAULT '1' COMMENT '1=Active, 2=>Inactive',
  `created_by` int DEFAULT NULL,
  `updated_by` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
(3, 1, 'Sale', 1, 1, 1, 5, 'ff', 'sfdf', NULL, 'hgh', 1000, NULL, NULL, 1, NULL, NULL, '2023-05-31 10:45:36', '2023-05-31 10:45:36');
...
INSERT INTO `residential_properties` (`id`, `property_master_id`, `descr`, `no_of_flats`, `total_bedrooms`, `total_balconies`, `total_bathrooms`, `total_floor`, `floor_allowed_for_construction`, `total_open_side`, `width_of_road_facing_plot`, `any_construction`, `boundary_wall_made`, `is_in_gated_colony`, `carpet_area`, `super_area`, `plot_area`, `plot_length`, `plot_breadth`, `furnished_status`, `possession_status`, `age`, `time_duration`, `monthly_rent`, `security_amount`, `maintenance_charges`, `charges_per`, `flag`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 1, 'fd', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, '2023-05-15 13:23:15', '2023-05-15 13:23:15'),
(2, 2, 'f', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, '2023-05-15 13:44:13', '2023-05-15 13:44:13'),
(3, 3, 'fgfg', '<50', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, '2023-05-31 10:45:36', '2023-05-31 10:45:36');
