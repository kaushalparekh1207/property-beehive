        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="header-title">
                    <h1>Roles</h1>
                    <small>Add New Roles</small>
                    <ol class="breadcrumb">
                        < <li class="breadcrumb-item">
                            <a href="{{ route('index') }}"><i class="pe-7s-home"></i></a>
                            </li>
                            <li class="breadcrumb-item">Admin Roles List
                            </li>
                    </ol>
                </div>
            </section>
                        ...
                        <div class="panel panel-bd">
                            ...
                            <div class="panel-body">
                                {{-- <button type="button"  class="btn btn-success"><a href="{{ route('state_add') }}"><i class="fa fa-plus"></i> Add
                                    New</a></button> --}}
                                <a type="button" href="{{ route('roles_add') }}" id=""
                                    class="btn btn-success">+ Add New</a>
                                <div class="table-responsive" style="margin-top: 2%;">
                                    <table id="adminRoles" class="table table-striped table-bordered nowrap">
                                        <thead>
                                            <tr>
                                                <th>Sr No.</th>
                                                <th>Role Name</th>
