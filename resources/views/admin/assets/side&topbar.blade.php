  ...
  <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__wobble" src="{{ url('/') }}/dist/img/logo-loding.png" alt="AdminLTELogo" height="60"
          width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
          <img src="{{ url('/') }}/dist/img/logo-loding.png" alt="AdminLTE Logo"
              class="brand-image img-circle elevation-3" style="opacity: .8">
          <span class="brand-text font-weight-light">Property Beehive</span>
      </a>
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item @yield('Property')">
                  ...
                  <li class="nav-item @yield('setup')">
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="{{ route('Subscription') }}" class="nav-link @yield('Subscription')">
                                  <i class="fas fa-angle-right nav-icon ml-1"></i>
                                  <p>Subscription</p>
                              </a>
                          </li>
  ...
  @section('footer')
      ...
      <footer class="main-footer">
          <strong>Copyright &copy; 2023, Property Beehive. Design & Developed By <a target="_blank"
                  href="https://hackberrysoftech.com">Hackberry Softech</a></strong>
          All Rights Reserved.
