        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="header-title">
                    <h1>Dashboard</h1>
                    <small>Very detailed & featured Dashboard.</small>
                    <ol class="breadcrumb">
                ...
                <div class="row">
                        ...
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <h2><span class="count-number">206</span> <span class="slight"><i
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <h2><span class="count-number">321</span> <span class="slight"><i
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <h2><span class="count-number">789</span> <span class="slight"><i
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <h2><span class="count-number">171</span><span class="slight"><i
                            ...
                            <div class="panel-body">
                                <ul class="activity-list list-unstyled">
                                    <li class="activity-purple">
                                        ...
                                        <p>You <span class="label label-success label-pill">recommended</span> Karen
                                            Ortega</p>
                                    </li>
                        ...
                        <div class="panel panel-bd lobidisable">
                                ...
                                <ul class="chat_list">
                                    <li class="clearfix">
                                        <div class="chat-avatar">
                                            ...
                                            <img src="{{ url('/') }}/admin/assets/dist/img/avatar.png"
                                                alt="male">
                                            <i>10:00</i>
                                        </div>
                            ...
                            <div class="panel-footer">
                                <div class="input-group">
                                    <input type="text" class="form-control emojionearea"
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Lavoir</td>
                                                <td><a href="#" class="btn btn-success btn-xs active">View</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Tanjil Ahmed</td>
