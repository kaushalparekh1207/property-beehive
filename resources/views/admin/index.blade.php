                                                        ...
                                                        <div class="latest-update-box">
                                                            <div class="row p-t-20 p-b-30">
                                                                <div class="col-auto text-right update-meta p-r-0">
                                                                    <img src="{{ url('/') }}/assets/images/avatar-4.jpg"
                                                                        alt="user image"
                                                ...
                                                <div class="card new-cust-card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="align-middle m-b-35">
                                                            <img src="{{ url('/') }}/assets/images/avatar-2.jpg"
                                                                alt="user image"
                                                        ...
                                                        <div class="align-middle m-b-35">
                                                            <img src="{{ url('/') }}/assets/images/avatar-3.jpg"
                                                                alt="user image"
                                                                class="img-radius img-40 align-top m-r-15">
                                                            <div class="d-inline-block">
                                                                <a href="#!">
                                                        ...
                                                        <div class="latest-update-box">
                                                            <div class="row p-t-20 p-b-30">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <img src="{{ url('/') }}/assets/images/mega-menu/01.jpg"
                                                                        alt class="img-fluid img-100 m-r-15 m-b-10">
                                                                    <img src="{{ url('/') }}/assets/images/mega-menu/03.jpg"
                                                                        alt class="img-fluid img-100 m-r-15 m-b-10">
                                                                </div>
                                                            </div>
                                                            <div class="row p-b-30">
