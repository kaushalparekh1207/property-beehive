            ...
            <section class="content">
                <div class="containter-fluid">
                    <div class="card card-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="{{ route('subscription_update') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <input type="hidden" name="sub_id" value="{{ $package->id }}">
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-2">Enter Subscription Name:
                                        <sup>*</sup></label>
                                    <div class="col-sm-10">
                                        <input name="package_name" type="text" class="form-control"
                                            placeholder="Enter Subscription Name" value="{{ $package->package_name }}"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="package_type" type="text" class="form-control"
                                            placeholder="Enter Subscription type" value="{{ $package->package_type }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="number_of_listing_property" type="number" class="form-control"
                                            ...
                                            value="{{ $package->number_of_listing_property }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="number_of_ads" type="number" class="form-control"
                                            placeholder="Enter Number Ads" value="{{ $package->number_of_ads }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="price" type="number" class="form-control"
                                            placeholder="Enter Subscription Price" value="{{ $package->price }}">
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
