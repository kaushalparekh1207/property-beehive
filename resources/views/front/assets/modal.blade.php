    ...
    <div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
        <div class="modal-content" id="loginmodal">
            ...
            <div class="modal-header">
                <div class="mdl-thumb"><img src="{{url('/')}}/front/assets/img/brand/PROPERTY_BEEHIVE_LOGO.png" class="img-fluid"
                                            width="200" alt=""></div>
                <div class="mdl-title">
            ...
            <div class="modal-footer">
                <p>Don't have an account yet?<a href="{{route('sign_up')}}" class="theme-cl font--bold ms-1">Sign Up</a>
                </p>
            </div>
        </div>
    </div>
