...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="image-cover hero-header"
            style="background:url({{ url('/') }}/front/assets/img/brand/buy.jpg) no-repeat;" data-overlay="6">
            <div class="container">
                ...
                <div class="full-search-2 mt-5">
                    <form id="buy_property_result" action="{{ route('searchBuyProperty') }}" method="post">
                        @csrf
                            ...
                            <div class="row classic-search-box m-0 gx-2">
                                ...
                                <div class="col-xl-1 col-lg-3 col-md-12 col-sm-12">
                                    <div class="fliox-search-wiop">
                                        <div class="form-group">
                                            <button type="button" id="buybtnSubmit"
        ...
        <section>
            <div class="container">
                ...
                <div class="row justify-content gx-3 gy-4">
                    ...
                    @if (count($residentialproperties) >= 1)
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-md-10 text-center">

                                <h2>Residential Properties on Buy</h2>
                    ...
                    @if (count($commercialproperties) >= 1)
                        <div class="row justify-content-center mt-2">
                            <div class="col-lg-7 col-md-10 text-center">

                                <h2>Commercial Properties on Buy</h2>
                    ...
                    @if (count($industrialproperties) >= 1)
                        <div class="row justify-content-center mt-2">
                            <div class="col-lg-7 col-md-10 text-center">

                                <h2>Industrial Properties on Buy</h2>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="swiper mySwiper">
                                        <div class="swiper-wrapper">
                                            @foreach ($industrialproperties as $property)
                                                <div class="swiper-slide">
                    ...
                    @if (count($agriculturalproperties) >= 1)
                        <div class="row justify-content-center mt-2">
                            <div class="col-lg-7 col-md-10 text-center">

                                <h2>Agricultural Properties on Buy</h2>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="swiper mySwiper">
                                        <div class="swiper-wrapper">
                                            @foreach ($agriculturalproperties as $property)
                                                <div class="swiper-slide">
