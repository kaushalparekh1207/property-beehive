                                        ...
                                        <div class="col-xl-9 col-lg-9 col-md-12">
                                            <div class="dashboard-body">
                                                ...
                                                <div class="dashboard-wraper">
                                                    ...
                                                    <!-- Basic Information -->
                                                    <form class="form-horizontal" id="myForm2" method="POST" action="{{ route('postChangePassword') }}">
                                                        @csrf
                                                        ...
                                                        <div class="frm_submit_wrap">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-lg-12 col-md-12">
                                                                    <button class="btn btn-primary" type="submit" id="PasswordChange">Save Changes</button>
                                                                </div>
