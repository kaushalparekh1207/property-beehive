            ...
            <div class="row justify-content gx-3 gy-4">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <div class="veshm-list-wraps">
                        ...
                        <div class="veshm-type fr-sale"><span>For {{$property->property_status}}</span></div>
                            ...
                            <div class="veshm-list-head">
                                <div class="veshm-list-head-caption">
                                    <div class="rlhc-price">
                                        <h4 class="rlhc-price-name theme-cl">₹{{$property->expected_price}}</h4>
                                    </div>
                                    <div class="listing-short-detail-flex">
                                        <h5 class="rlhc-title-name verified"><a href="single-property-1.html"
                                                                                class="prt-link-detail">{{$property->name_of_project}}</a></h5>
                                    </div>
                                    <div class="veshm-list-icons">
                                        <ul>
                                            <li><i class="fa-solid fa-bed"></i><span>{{$property->total_bedrooms}} Bed</span></li>
                                            <li><i class="fa-solid fa-bath"></i><span>{{$property->total_bathrooms}}  Ba</span></li>
                                            <li><i class="fa-solid fa-vector-square"></i><span>{{$property->carpet_area}}  sft</span></li>
                                        </ul>
                                    </div>
                                </div>
