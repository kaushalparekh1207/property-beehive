...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="image-cover hero-header"
            style="background:url({{ url('/') }}/front/assets/img/brand/land.jpg) no-repeat;" data-overlay="6">
            <div class="container">

                <div class="inner-banner-text text-center">
                    <h1>Properties to Land in <br>Ahmedabad</h1>

                </div>

                <div class="full-search-2 mt-5">
                    <form id="property_result" action="{{ route('searchLandProperty') }}" method="post">
                        @csrf
