                                            ...
                                            <div class="row gx-4 gy-4">
                                                ...
                                                <div class="col-xl-4 collg-4 col-md-4 col-sm-12 col-12">
                                                    <div class="veshm-pricing-box">
                                                        ...
                                                        <div class="veshm-pricing-content">
                                                            <ul>
                                                                <li><i class="fa-solid fa-circle-check"></i>2+ Listings</li>
                                                                <li><i class="fa-solid fa-circle-check"></i>5 Buyer</li>
                                                                <li><i class="fa-solid fa-circle-check"></i>0 Ads</li>
                                                                <li><i class="fa-solid fa-circle-check"></i>Contact With Agent</li>
                                                                <li class="deactive"><i class="fa-solid fa-circle-xmark"></i>No Support</li>
                                                                <li class="deactive"><i class="fa-solid fa-circle-xmark"></i>Dashboard</li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="veshm-pricing-box featured">
                                                        ...
                                                        <div class="veshm-pricing-content">
                                                            <ul>
                                                                ...
                                                                <li><i class="fa-solid fa-circle-check"></i>15 Buyer</li>
                                                ...
                                                <div class="col-xl-4 collg-4 col-md-4 col-sm-12 col-12">
                                                    <div class="veshm-pricing-box">
                                                        ...
                                                        <div class="veshm-pricing-content">
                                                            <ul>
                                                                <li><i class="fa-solid fa-circle-check"></i>10+ Listings</li>
                                                                <li><i class="fa-solid fa-circle-check"></i>25 Buyer</li>
                                                                <li><i class="fa-solid fa-circle-check"></i>10 Ads</li>
                                                                <li><i class="fa-solid fa-circle-check"></i>Contact With Agent</li>
                                                                <li><i class="fa-solid fa-circle-check"></i>24x7 Fully Support</li>
